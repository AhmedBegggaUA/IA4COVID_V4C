...
fechas_prediccion = [("2021-08-09","2021-08-23"), ("2021-08-23","2021-09-06"), ("2021-09-06","2021-09-20"), ("2021-09-20","2021-10-04"), ("2021-10-04","2021-10-18"), ("2021-10-18","2021-11-01"), ("2021-11-01","2021-11-15"),
...
fechas_entrenamiento = [("2020-09-01", "2021-08-08"), ("2020-09-01", "2021-08-22"), ("2020-09-01", "2021-09-05"), ("2020-09-01", "2021-09-19"), ("2020-09-01", "2021-10-03"), ("2020-09-01", "2021-10-17"), ("2020-09-01", "2021-10-31"),
("2020-09-01", "2021-11-14"), ("2020-09-01", "2021-11-28"), ("2020-09-01", "2021-12-12"), ("2020-09-01", "2021-12-26")]  
...
train_preset = ModelPreset.VAC_H7
...
for i in range(1, 51):
    ...
    #   # path_to_model = f"model_23_03_23/valencia_model_weights_"+str(i)+"_"+str(j)+".h5" # La i indica el trial y la j el mes
        path_to_model = f"oscar_H7/models2/valencia_model_weights_"+str(i)+"_"+str(j)+".h5" # La i indica el trial y la j el mes
   ...
   #     #preds_df.to_csv("predictions/23_03_23/robojudge_test_"+str(i)+"_"+str(j)+".csv", index=False)
        preds_df.to_csv("oscar_H7/predictions2/robojudge_test_"+str(i)+"_"+str(j)+".csv", index=False)
   ...
   #     #df_mae.to_csv("maes_23.csv", index=False)
        df_mae.to_csv("oscar_H7/second_half_maes_H7.csv", index=False)
